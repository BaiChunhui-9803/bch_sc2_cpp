...
char *RptSectTxt[] = { nullptr,       t_JUNCTION, t_RESERVOIR,
...
char *LogoTxt[] = { LOGO1,LOGO2,LOGO3,LOGO4,LOGO5,LOGO6,nullptr };

/*rules*/
char *Ruleword[] = { w_RULE,w_IF,w_AND,w_OR,w_THEN,w_ELSE,w_PRIORITY,nullptr };
...
char *Operator[] = { "=","<>","<=",">=","<",">",w_IS,w_NOT,w_BELOW,w_ABOVE,nullptr };
char *Value[] = { "XXXX",   w_OPEN, w_CLOSED, w_ACTIVE,nullptr };
