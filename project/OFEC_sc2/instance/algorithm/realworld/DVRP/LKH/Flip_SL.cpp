 ...
 */
namespace LKH {
	static void SplitSegment(LKHAlg::Node * t1, LKHAlg::Node * t2);

#define SPLIT_CUTOFF 0.75

	void LKHAlg::Flip_SL(Node * t1, Node * t2, Node * t3)
	{
		Node *t4, *a = 0, *b = 0, *c = 0, *d = 0;
		...
		if (b) {
			int Cbc = (this->*C)(b, c), Cda = (this->*C)(d, a);
	...
	void SplitSegment(LKHAlg::Node * t1, LKHAlg::Node * t2)
	{
		LKHAlg::Segment *P = t1->Parent, *Q;
		LKHAlg::Node *t, *u;
		int i, Temp, Count;
