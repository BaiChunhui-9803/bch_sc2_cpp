 ...
 */
namespace LKH {
	static void SelectForward(LKHAlg::Node ** a, LKHAlg::Node ** b, LKHAlg::Node * from, LKHAlg::Node * to, LKHAlg *Alg);
	static void SelectBackward(LKHAlg::Node ** a, LKHAlg::Node ** b, LKHAlg::Node * from, LKHAlg::Node * to, LKHAlg *Alg);

	LKHAlg::Node *LKHAlg::BestSpecialOptMove(LKHAlg::Node * t1, LKHAlg::Node * t2, GainType * G0,
		GainType * Gain)
	{
		Node *t3 = 0, *t4 = 0, *t5 = 0, *t6 = 0, *t7 = 0, *t8 = 0,
		...
		for (Nt2 = t2->CandidateSet; (t3 = Nt2->To); Nt2++) {
			...
			for (X4 = 1; X4 <= 2; X4++) {
				...
				if (X4 == 1 && !Forbidden(t4, t1) &&
					(CurrentPenalty > 0 ||
						TSPTW_Makespan || !c || G2 - (this->*c)(t4, t1) > 0)) {
					*Gain = G2 - (this->*C)(t4, t1);
				...
				for (Nt4 = t4->CandidateSet; (t5 = Nt4->To); Nt4++) {
					...
					for (X6 = 1; X6 <= X4; X6++) {
						...
						if (!Forbidden(t6, t1) &&
							(CurrentPenalty > 0 ||
								TSPTW_Makespan || !c || G4 - (this->*c)(t6, t1) > 0)) {
							*Gain = G4 - (this->*C)(t6, t1);
							if (CurrentPenalty > 0 ||
								TSPTW_Makespan || *Gain > 0) {
								NewPenalty =
									BIT_LoadDiff3Opt(t1, t2, t3, t4, t5, t6, this) -
									Capacity;
						...
						if (K < 5) {
							...
							if (!Backtracking || Swaps > 0) {
								...
								Exclude(t5, t6);
								while ((t =
									(this->*BestSubsequentMove)(t1, t, &G, Gain)));
				...
				for (Case56 = 1; Case56 <= 2; Case56++) {
					if (Case56 == 1) {
						SelectBackward(&t6, &t5, t3, t2, this);
						if (t6 == t2)
							break;
						t6Old = t6;
					}
					else {
						SelectForward(&t5, &t6, t2, t3, this);
						if (t5 == t3 || t6 == t6Old)
							break;
					}
					...
					if (!Asymmetric &&
						...
						G4 = G2 - (this->*C)(t4, t6) + (this->*C)(t5, t6);
						if (CurrentPenalty > 0 ||
							TSPTW_Makespan || !c || G4 - (this->*c)(t5, t1) > 0) {
							*Gain = G4 - (this->*C)(t5, t1);
							if (CurrentPenalty > 0 ||
								TSPTW_Makespan || *Gain > 0) {
				...
				if (!Forbidden(t4, t1)) {
					...
					if (!Asymmetric) {
						...
						if (t6 != t2 && !FixedOrCommon(t5, t6)) {
							SelectForward(&t8, &t7, t4, t1, this);
							if (t8 != t1 &&
								!Forbidden(t6, t7) &&
								!Forbidden(t8, t5) && !FixedOrCommon(t7, t8)) {
								*Gain = G3 + (this->*C)(t5, t6) - (this->*C)(t6, t7) +
									(this->*C)(t7, t8) - (this->*C)(t8, t5);
								if (CurrentPenalty > 0 ||
									TSPTW_Makespan || *Gain > 0) {
					...
					for (Case56 = 1; Case56 <= 2; Case56++) {
						...
						for (Case78 = 1; Case78 <= 2; Case78++) {
							if (Case78 == 1) {
								SelectBackward(&t8, &t7, t1, t4, this);
								if (t8 == t4)
									break;
								t7Old = t7;
							}
							else {
								SelectForward(&t7, &t8, t4, t1, this);
								if (t7 == t1 || t7 == t7Old)
									break;
							}
							G4 = G3 + (this->*C)(t5, t6) + (this->*C)(t7, t8);
							if (!Forbidden(t6, t7) && !Forbidden(t8, t5)) {
								if (CurrentPenalty > 0 ||
									TSPTW_Makespan ||
									!c || G4 - (this->*c)(t6, t7) - (this->*c)(t8, t5) > 0) {
									*Gain = G4 - (this->*C)(t6, t7) - (this->*C)(t8, t5);
									if (CurrentPenalty > 0 ||
										TSPTW_Makespan || *Gain > 0) {
										NewPenalty =
							...
							if (!Asymmetric &&
								...
								if (CurrentPenalty > 0 ||
									TSPTW_Makespan ||
									!c || G4 - (this->*c)(t5, t7) - (this->*c)(t6, t8) > 0) {
									*Gain = G4 - (this->*C)(t5, t7) - (this->*C)(t6, t8);
									if (CurrentPenalty > 0 ||
										TSPTW_Makespan || *Gain > 0) {
				...
				for (Case = 1; Case <= 33; Case++) {
					...
					if (Case <= 6) {
						if (Case <= 3) {
							if (Case == 1) {
								SelectBackward(&t8, &t7, t3, t2, this);
								if (t8 == t2) {
									Case = 3;
									continue;
								}
							...
							SelectForward(&t7, &t8, t2, t3, this);
							if (t7 == t3)
								continue;
						}
						if (Case == 1 || Case == 2 || Case == 4 || Case == 5) {
							SelectForward(&t9, &t10, t4, t1, this);
							if (t9 == t1)
								continue;
							if (Case == 1 || Case == 4) {
								SelectForward(&t5, &t6, t10, t1, this);
								if (t5 == t1)
									continue;
							}
							else {
								SelectBackward(&t6, &t5, t1, t10, this);
								if (t6 == t10)
									continue;
							}
						}
						else {
							SelectBackward(&t6, &t5, t1, t4, this);
							if (t6 == t4)
								continue;
							SelectBackward(&t10, &t9, t5, t4, this);
							if (t10 == t4)
								continue;
						}
						Case10 = 4;
						...
						if (Case <= 9) {
							SelectBackward(&t10, &t9, t3, t2, this);
							if (t10 == t2)
								continue;
						}
						else {
							SelectForward(&t9, &t10, t2, t3, this);
							if (t9 == t3)
								continue;
						}
						if (Case == 7 || Case == 8 || Case == 10 || Case == 11) {
							...
							if (t7 == t1)
								continue;
							if (Case == 7 || Case == 10) {
								SelectForward(&t5, &t6, t8, t1, this);
								if (t5 == t1)
									continue;
							}
							else {
								SelectBackward(&t6, &t5, t1, t8, this);
								if (t6 == t8)
									continue;
							}
						}
							...
							if (t6 == t4)
								continue;
							SelectBackward(&t8, &t7, t5, t4, this);
							if (t8 == t4)
								continue;
						}
						Case10 = 5;
						...
						if (Case == 13 || Case == 14 ||
							...
							if (t6 == t2)
								continue;
							if (Case == 13 || Case == 16) {
								SelectBackward(&t10, &t9, t5, t2, this);
								if (t10 == t2)
									continue;
							}
							else {
								SelectForward(&t9, &t10, t2, t5, this);
								if (t9 == t5)
									continue;
							}
						}
							...
							if (t9 == t3)
								continue;
							SelectForward(&t5, &t6, t10, t3, this);
							if (t5 == t3)
								continue;
						}
						Case10 = 13;
						...
						if (Case == 19 || Case == 20 ||
							...
							if (t10 == t2)
								continue;
							if (Case == 19 || Case == 22) {
								SelectBackward(&t6, &t5, t9, t2, this);
								if (t6 == t2)
									continue;
							}
							else {
								SelectForward(&t5, &t6, t2, t9, this);
								if (t5 == t9)
									continue;
							}
						}
							...
							if (t5 == t3)
								continue;
							SelectForward(&t9, &t10, t6, t3, this);
							if (t9 == t3)
								continue;
						}
						Case10 = 14;
						...
						if (Case == 25 || Case == 26 ||
							...
							if (t9 == t1)
								continue;
							if (Case == 25 || Case == 28) {
								SelectForward(&t7, &t8, t10, t1, this);
								if (t7 == t1)
									continue;
							}
							else {
								SelectBackward(&t8, &t7, t1, t10, this);
								if (t8 == t10)
									continue;
							}
						}
							...
							if (t8 == t4)
								continue;
							SelectBackward(&t10, &t9, t7, t4, this);
							if (t10 == t4)
								continue;
						}
						Case10 = 15;
						...
						if (t8 == t2)
							continue;
						SelectBackward(&t10, &t9, t7, t2, this);
						if (t10 == t2)
							continue;
						SelectBackward(&t6, &t5, t9, t2, this);
						if (t6 == t2)
						...
						if (t6 == t2)
							continue;
						SelectBackward(&t8, &t7, t5, t2, this);
						if (t8 == t2)
							continue;
						SelectBackward(&t10, &t9, t7, t2, this);
						if (t10 == t2)
					...
					G7 = G6 - (this->*C)(t8, t9);
					G8 = G7 + (this->*C)(t9, t10);
					*Gain = G8 - (this->*C)(t10, t1);
					if (CurrentPenalty > 0 || TSPTW_Makespan || *Gain > 0) {
						NewPenalty =
							BIT_LoadDiff5Opt(t1, t2, t3, t4, t5, t6,
								t7, t8, t9, t10, Case10, this) -
							Capacity;
						if (NewPenalty < CurrentPenalty ||
					...
					if (!Backtracking || Swaps > 0) {
						...
						Exclude(t7, t8);
						Exclude(t9, t10);
						while ((t = (this->*BestSubsequentMove)(t1, t, &G, Gain)));
						if (*Gain > 0)
							return 0;
						RestoreTour();
						if (t2 != SUC(t1))
				...
				for (Case = 1; Case <= 8; Case++) {
					...
					if (Case == 4 || Case == 8) {
						SelectBackward(&t12, &t11, t1, t4, this);
						if (t12 == t4)
							continue;
						SelectBackward(&t6, &t5, t11, t4, this);
						if (t6 == t4)
							continue;
						SelectBackward(&t10, &t9, t5, t4, this);
						if (t10 == t4)
						...
						if (t9 == t1)
							continue;
						if (Case == 3 || Case == 7) {
							SelectBackward(&t12, &t11, t1, t10, this);
							if (t12 == t10)
								continue;
							SelectBackward(&t6, &t5, t11, t10, this);
							if (t6 == t10)
								continue;
						}
						else {
							...
							if (t5 == t1)
								continue;
							if (Case == 1 || Case == 5) {
								SelectForward(&t11, &t12, t6, t1, this);
								if (t11 == t1)
									continue;
							}
							else {
								SelectBackward(&t12, &t11, t1, t6, this);
								if (t12 == t6)
									continue;
							}
						}
					...
					if (t6 == t1 ||
						...
						continue;
					G4 = G2 + (this->*C)(t5, t6) + (this->*C)(t7, t8) + (this->*C)(t9, t10) + (this->*C)(t11, t12);
					if (CurrentPenalty > 0 ||
						TSPTW_Makespan ||
						!c || G4 - (this->*c)(t4, t5) - (this->*c)(t6, t1) - (this->*c)(t8, t9)
						- (this->*c)(t10, t11) - (this->*c)(t12, t7) > 0) {
						*Gain = G4 - (this->*C)(t4, t5) - (this->*C)(t6, t1) - (this->*C)(t8, t9)
							- (this->*C)(t10, t11) - (this->*C)(t12, t7);
						if (CurrentPenalty > 0 || TSPTW_Makespan || *Gain > 0) {
							NewPenalty =
								BIT_LoadDiff6Opt(t1, t2, t3, t4, t5, t6,
									t7, t8, t9, t10, t11, t12, this) -
								Capacity;
							if (NewPenalty < CurrentPenalty ||
								(NewPenalty == CurrentPenalty && *Gain > 0)) {
	...
	{
		*a = from;
		*b = (Alg->Reversed == (*a)->Parent->Reversed ? (*a)->Suc : (*a)->Pred);
		while (*a != to && (Fixed(*a, *b) || Alg->IsCommonEdge(*a, *b))) {
			*a = *b;
			*b = (Alg->Reversed == (*a)->Parent->Reversed ? (*a)->Suc : (*a)->Pred);
		}
	}
	...
	{
		*a = from;
		*b = (Alg->Reversed == (*a)->Parent->Reversed ? (*a)->Pred : (*a)->Suc);
		while (*a != to && (Fixed(*a, *b) || Alg->IsCommonEdge(*a, *b))) {
			*a = *b;
			*b = (Alg->Reversed == (*a)->Parent->Reversed ? (*a)->Pred : (*a)->Suc);
		}
