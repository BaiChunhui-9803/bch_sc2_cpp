...
*
*-------------------------------------------------------------------------------
* Individual for combinatorial problem that can be transformed to problem with edges
*
*********************************************************************************/

#ifndef OFEC_SEQUENCE_SOLUTION_H
#define OFEC_SEQUENCE_SOLUTION_H
...
namespace ofec {
	...
	//void calculateDensityMatrix(const std::vector<std::unique_ptr<TIndividual>>& indis,
