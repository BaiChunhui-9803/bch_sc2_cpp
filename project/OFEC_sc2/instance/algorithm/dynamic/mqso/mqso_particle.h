...
namespace ofec {
    ...
    public:
        ...
        void nextVelocity(const Solution<>* best, Real w, Real c1, Real c2, int id_rnd) override;
        void move() override;
        void quantumMove(const Solution<>* lbest, Real m_Rcloud,int id_rnd);
        ...
        void initializeVmax(int id_pro);
        virtual void initVelocity(int id_pro, int id_rnd) override;
